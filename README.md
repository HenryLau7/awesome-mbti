...
> **Note:** 这里的项目横跨娱乐、梗图、研究展示与半严肃工具，**科学有效性**差异很大。默认把它们视为互联网文化项目或产品案例，而不是心理测量学背书。本仓库仅做收录，不代表对任何测试具有倾向认同，请大家自行判断。内容为手工录入，如有错误，请联系作者：[`yuanyeliu7@gmail.com`](mailto:yuanyeliu7@gmail.com)。

## Projects

> 排序说明：按项目名中的英文缩写或拉丁字母标识首字母排序；中文标题项目排在后面。

| Project | Description | Credit | Links |
|:--------|:------------|:-------|:------|
...
| **BJTI (紫禁城人格测试)** | 测测你在紫禁城里，究竟会活成谁的路数 | *待认领* | [Demo](https://bjti.flagrain.cn/) |
...
| **DVTI (DivaTI)** | 姐妹，你本体素哪位 Diva？也许素 HORNY、CALM-D，也许素个性耀眼的 GXYY… | 卡拉zz@小红书 | [Demo](https://dvti.top/) |
...
| **RCTI (攀岩人格测试)** | 专为攀岩人设计的垂直人格测试，你的攀岩灵魂，究竟会解锁哪种隐藏人格？ | Listen2Me@小红书 | [Demo](https://rcti.senlei.site/) |
| **RDTI (骑行人格测试)** | 专为骑行领域设计的垂直人格测试，揭示你的骑行灵魂代码 | Listen2Me@小红书 | [Demo](https://ridetype.senlei.site/) |
...
| **SBTI (音乐版)** | 音乐版 SBTI 来了。 | 音乐格子间@小红书 | [Demo](https://music-sbti.xyz/) |
| **SDTI** | 新型人格测试。 | Shift开发组等 | [Demo](https://sdtis.com/) |
| **SGRW (是个人物)** | 借古代文学人物一用，看看你究竟是仗剑辞家的谪仙、夜半拉人看月的苏轼，还是群聊里那个只回"收到"的老儒。 | 一十四画生@小红书 | [Demo](https://sgrw.forsion.net/) |
| **SJTI (交通大学人格测试)** | 交通大学主题的人格测试。 | *待认领* | [Demo](https://sjti.netlify.app) |
| **SMTI** | 测出你在关系里到底是折磨人的那个还是被折磨的那个 | *待认领* | [Demo](https://www.smtitest.top/) |
| **SPTI (花生村)** | Snoopy Personality Type Indicator。 | OCunning_Lúc@小红书 | [Demo](https://ocunningluc.com/peanuts-mbti-test) |
...
| **WTFTI** | 一份写给当代女性的人格图鉴。同一个你，在不同宇宙里，被翻译成完全不同的样子。 | 洛拉AI@小红书 | [Demo](https://www.wtfti.com/) |
| **WTM (我不太聪明人格测试)** | 这是一个专门为“人间清醒但偶尔犯迷糊”的聪明人们准备的趣味测试！ | Samuel拍档@小红书 | [Demo](https://www.axureshow.com/yanshi/2GR4Jres/) |
| **XCTI (新传人格测试)** | 一个测试你更像哪个传播学流派的娱乐性人格测试。 | SATELLITE@小红书 | [Demo](https://xiaochunlilywang.github.io/XCTI/) |
...
| **女BTI：赛博女性精神状态测试** | 这是最好的时代，也是最坏的时代。可能是最尖锐的，也可能是最温和的测试题，可能是最认真的，也可能是最乐子的测试题。打入什么结局，取决于你。 | 鼓手女巫×昭然绝对律@小红书 | [Demo](https://nvbti.pages.dev/) |
| **牛马TI** | MBTI 先放一边，NMTI 来了。先看看你在办公室到底是卷王、演王、背锅侠，还是精神股东。 | [kbr19-thu](https://kbr19-thu.github.io/) | [Demo](https://kbr19-thu.github.io/nmti2026) / [Repo](https://github.com/kbr19-thu/nmti2026) |

> *待认领* 表示暂未确认原作者，欢迎作者本人或知情者通过 [Issue](https://github.com/HenryLau7/awesome-mbti/issues) 或 PR 来认领。

## Contributing

欢迎补充新的 MBTI-like 项目。请先阅读 [CONTRIBUTING.md](CONTRIBUTING.md)。
